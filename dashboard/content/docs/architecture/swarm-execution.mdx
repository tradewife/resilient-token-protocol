...
description: How the autonomous agent swarm executes yield strategies via Flash Trade CPI on Solana.
---
...
| **Knowledge** | Persistent knowledge store (JSON file-backed), cross-wing queries |
