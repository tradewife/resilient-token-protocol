    ...
    items: [
      {
        ...
        content: (
          <>
            <p>RTP (Resilient Token Protocol) gives every token a program-enforced treasury vault on Solana. Trading fees accumulate in the vault, the Treasury PDA executes yield strategies on Solana-native perpetuals, and yield flows back to holders, developers, and ecosystem (70/20/10 split, enforced on-chain). Forever.</p>
            ...
            <ul>
              ...
              <li><strong>Self-funding economics:</strong> treasury generates its own yield on Solana-native perps, with irreversible phase evolution (Sustenance → Ecosystem → Humanity). No VC dependency.</li>
              ...
              <li><strong>Real execution:</strong> Treasury PDA signs via invoke_signed; positions open/close on-chain. Mainnet CPI proofs: Open TX 2bLg1Fu..., Close TX dFqkoP2.... The venue layer is measured, not assumed: after Flash Trade&apos;s Aug 2026 wind-down, the engine was re-validated on GMTrade&apos;s live on-chain costs (10/10 gates). SOL never leaves Solana.</li>
            ...
            <ol>
              ...
              <li><strong>Swarm trades:</strong> the Treasury PDA executes validated strategies on Solana-native perps (invoke_signed), or the live autonomous trader executes directly via the venue API. No cross-chain bridge. Each token&apos;s capital is traded independently.</li>
...
│  Trading → venue CPI/API → on-chain perps → SOL       │
...
└──────────────────────────────────────────────────────┘
  ...
  Capital: SOL → Treasury PDA → venue perps → SOL yield → PDA`}</pre>
            </div>
            ...
            <Table
              ...
              rows={[
                ...
                ["Venue execution (CPI/API)", "✅ Mainnet proofs", "Treasury PDA invoke_signed, positions open/close on-chain (Open TX 2bLg1Fu..., Close TX dFqkoP2...); venue re-validation on measured costs proven live"],
